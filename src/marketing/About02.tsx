...
import { ButtonLink, PlainButtonLink } from './vendor/elements/button'
import { Main } from './vendor/elements/main'
import { ChevronIcon } from './vendor/icons/chevron-icon'
import { GitDiffIcon } from './vendor/icons/git-diff-icon'
import { HeartIcon } from './vendor/icons/heart-icon'
import { RocketIcon } from './vendor/icons/rocket-icon'
import { StarIcon } from './vendor/icons/star-icon'
import { TargetIcon } from './vendor/icons/target-icon'
import { User2Icon } from './vendor/icons/user-2-icon'
import { BrandCard, BrandsCardsMultiColumn } from './vendor/sections/brands-cards-multi-column'
import { CallToActionSimple } from './vendor/sections/call-to-action-simple'
import { Feature, FeaturesThreeColumn } from './vendor/sections/features-three-column'
import { FooterCategory, FooterLink, FooterWithLinkCategories } from './vendor/sections/footer-with-link-categories'
import { HeroTwoColumnWithPhoto } from './vendor/sections/hero-two-column-with-photo'
import {
  NavbarLink,
  NavbarLogo,
  NavbarWithLogoActionsAndCenteredLinks,
} from './vendor/sections/navbar-with-logo-actions-and-centered-links'
import { TeamMember, TeamThreeColumnGrid } from './vendor/sections/team-three-column-grid'
  ...
  return (
    <>
      <NavbarWithLogoActionsAndCenteredLinks
        ...
        logo={
          <NavbarLogo href="/">
            <span className="font-display text-2xl text-taupe-950 dark:text-white">Ubayy.</span>
          </NavbarLogo>
        }
        actions={
          <>
