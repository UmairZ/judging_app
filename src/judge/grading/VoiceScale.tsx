...
export default function VoiceScale({ aq, voiceMax, setVoice }: { aq: Question; voiceMax: number; setVoice: (n: number) => void }) {
  return (
    <div style={{ background: '#fff', border: `1px solid ${C.cardLine}`, borderRadius: 12, padding: '13px 18px', display: 'flex', alignItems: 'center', gap: 22 }}>
      <div style={{ flex: 'none' }}>
        ...
        <div style={{ fontSize: 12, color: C.muted, marginTop: 2 }}>rate as you go · 0–{voiceMax}</div>
      </div>
