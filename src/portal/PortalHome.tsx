/* Tailwind Plus 'Catalyst' demo page, adapted under the Tailwind Plus license for this application.
 * Not for redistribution as a component library. https://tailwindcss.com/plus/license
 * SPA adaptation: async server component -> client component loading the mock data in an effect. */
...
import { getRecentOrders } from './demo-data'
  ...
  return (
    <>
      ...
      <Table className="mt-4 [--gutter:--spacing(6)] lg:[--gutter:--spacing(10)]">
        ...
        <TableBody>
          {orders.map((order) => (
            <TableRow key={order.id} href="#" title={`Order #${order.id}`}>
