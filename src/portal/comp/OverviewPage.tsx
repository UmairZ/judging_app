...
/**
 * Competition overview: name + status, the same four headline stats as the
 * org Home page, and a quick-facts list drawn from the structure config.
 * orgId/compId come from the enclosing TenantProvider — always real, never a
 * placeholder.
 */
